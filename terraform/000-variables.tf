...
locals {
 controller_nodes = {
    mnaio-controller1 = { mgmt_addr = "172.29.236.21", overlay_addr = "172.29.240.21", 
                          storage_addr = "172.29.244.21", provider_addr = "10.239.3.21" },
    mnaio-controller2 = { mgmt_addr = "172.29.236.22", overlay_addr = "172.29.240.22",
                          storage_addr = "172.29.244.22", provider_addr = "10.239.3.22" },
    mnaio-controller3 = { mgmt_addr = "172.29.236.23", overlay_addr = "172.29.240.23",
...
locals {
  compute_nodes = {
    mnaio-compute1 = { mgmt_addr = "172.29.236.31", overlay_addr = "172.29.240.31",
                       storage_addr = "172.29.244.31", provider_addr = "10.239.3.31" },
    mnaio-compute2 = { mgmt_addr = "172.29.236.32", overlay_addr = "172.29.240.32",
                       storage_addr = "172.29.244.32", provider_addr = "10.239.3.32" },
    mnaio-compute3 = { mgmt_addr = "172.29.236.33", overlay_addr = "172.29.240.33",
...
locals {
  loadbalancer_nodes = {
    mnaio-loadbalancer1 = { mgmt_addr = "172.29.236.41" },
    mnaio-loadbalancer2 = { mgmt_addr = "172.29.236.42" }
  }
}
...
locals {
  deployer_nodes = {
    mnaio-deploy1 = { mgmt_addr = "172.29.236.51" }
  }
}
...
locals {
  ceph_nodes = {
    mnaio-ceph1 = { mgmt_addr = "172.29.236.61", storage_addr = "172.29.244.61", replication_addr = "172.29.252.61" },
    mnaio-ceph2 = { mgmt_addr = "172.29.236.62", storage_addr = "172.29.244.62", replication_addr = "172.29.252.62" },
    mnaio-ceph3 = { mgmt_addr = "172.29.236.63", storage_addr = "172.29.244.63", replication_addr = "172.29.252.63" }
  }
}
